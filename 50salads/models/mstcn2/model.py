...
class MS_TCN2(nn.Module):
    def __init__(self, num_layers_PG, num_layers_R, num_R, num_f_maps, dim, num_classes, extract_features=False):
    ...
    def forward(self, x):
        ...
        features = None
        for R in self.Rs:
            out, features = R(F.softmax(out, dim=1))
...
class MS_TCN(nn.Module):
    def __init__(self, num_stages, num_layers, num_f_maps, dim, num_classes, feature_extraction=False):
